...
public class UsuarioController {
	...
	public boolean enviarEmailSenhaEsquecida(@Validated @RequestBody String emailUsuario) {
		...
		if (usuarioCadastrado != null) {
			...
			return enviarEmail(emailUsuario, mensagem, "SportRap - Senha esquecida");
		} else {
			return false;
		}
	...
	private boolean enviarEmail(String emailDestinatario, StringBuilder mensagem, String assunto) {
